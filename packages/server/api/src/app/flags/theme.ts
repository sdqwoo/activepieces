...
export const defaultTheme = generateTheme({
    primaryColor: '#083DC9',
    websiteName: '신한 AX Station',
    fullLogoUrl: '/src/assets/shinhan/shinhan-logo.png',
    favIconUrl: '/src/assets/shinhan/shinhanicon.ico',
    logoIconUrl: '/src/assets/shinhan/shinhanlogo.svg',
})
